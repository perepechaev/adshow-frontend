...
require_once(__DIR__ . '/FileUploadException.class.php');
...
class FileUpload
{
    ...
    static $MAX_UPLOAD_FILE_SIZE = 4194304; 
...
//            FileUploadException::NotIndicateUploadFile();
    ...
    public function upload($path, $filename = null){
        ...
        FileUploadException::maxFileSize($this->file['size'], self::$MAX_UPLOAD_FILE_SIZE);
